...
有这个需求是因为《无界 线上艺术》在春节上架了单雯和施夏明的传承版昆曲《牡丹亭》，是我苦苦寻找许久而未果的经典影像，雯明组合，也是我眼中这个时代最棒的杜丽娘和柳梦梅，所以一定要下载下来收入我的资源库。
...
当手机开始播放视频的时候，观察`Wireshark`会产生大量指向同一个`IP`的`TCP`数据包。
...
用浏览器打开，运气不错，是未分割的完整视频，直接保存到本地就可以了。
