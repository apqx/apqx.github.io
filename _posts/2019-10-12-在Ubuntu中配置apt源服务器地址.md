...
<img class="responsive-img" src="https://apqx.oss-cn-hangzhou.aliyuncs.com/note/pic/ubuntu_settings_apt.png" alt="pic">
...
<img class="responsive-img" src="https://apqx.oss-cn-hangzhou.aliyuncs.com/note/pic/ubuntu_settings_apt_source.png" alt="pic">

选择好后，在`Terminal`里更新一下包索引，可以看到，`apt源`已经变成阿里云的镜像地址了。

<img class="responsive-img" src="https://apqx.oss-cn-hangzhou.aliyuncs.com/note/pic/ubuntu_terminal_apt_update.png" alt="pic">
...
<img class="responsive-img" src="https://apqx.oss-cn-hangzhou.aliyuncs.com/note/pic/ubuntu_apt_cnserver_root.png" alt="pic">

进入`dists/`目录

<img class="responsive-img" src="https://apqx.oss-cn-hangzhou.aliyuncs.com/note/pic/ubuntu_apt_cnserver_dists.png" alt="pic">
...
<img class="responsive-img" src="https://apqx.oss-cn-hangzhou.aliyuncs.com/note/pic/ubuntu_apt_cnserver_bionic.png" alt="pic">
