...
description: 通常用于多分发渠道打包，我实际上很羡慕iOS只有一个App Store。
cover: https://apqx.oss-cn-hangzhou.aliyuncs.com/blog/pic/gradle_task_build_variant.jpg
categories: essy
...
![](https://apqx.oss-cn-hangzhou.aliyuncs.com/blog/pic/gradle_task_build_variant.jpg){: loading="lazy" }
...
![](https://apqx.oss-cn-hangzhou.aliyuncs.com/blog/pic/module_build_variant.png){: loading="lazy" }
