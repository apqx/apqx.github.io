...
![](https://apqx.oss-cn-hangzhou.aliyuncs.com/blog/pic/outline.jpg)
...
![](https://apqx.oss-cn-hangzhou.aliyuncs.com/blog/pic/outline_01.jpg)

其实，也可以说它支持所有`Linux`服务器，选择`Set up Outline anywhere`

![](https://apqx.oss-cn-hangzhou.aliyuncs.com/blog/pic/outline_02.jpg)
...
![](https://apqx.oss-cn-hangzhou.aliyuncs.com/blog/pic/outline_03.jpg)

将绿色的字符串（部分内容被我划掉了）复制到上图的空白处，`Outline Server`即创建完毕。

![](https://apqx.oss-cn-hangzhou.aliyuncs.com/blog/pic/outline_04.jpg)

# 使用Outline Server

点击红圈内的图标，会弹出下图的窗口（可能很久才弹出，和所处的网络环境有关），选择`CONNECT THIS DEVICE`

![](https://apqx.oss-cn-hangzhou.aliyuncs.com/blog/pic/outline_05.jpg)

![](https://apqx.oss-cn-hangzhou.aliyuncs.com/blog/pic/outline_06.jpg)
