...
![](https://apqx.oss-cn-hangzhou.aliyuncs.com/blog/20190611/https.jpg){: loading="lazy" }
...
![](https://apqx.oss-cn-hangzhou.aliyuncs.com/blog/20190611/https_ca.jpg){: loading="lazy" }
...
![](https://apqx.oss-cn-hangzhou.aliyuncs.com/blog/20190611/ssh.jpg){: loading="lazy" }
...
![](https://apqx.oss-cn-hangzhou.aliyuncs.com/blog/20190611/ssh_key.jpg){: loading="lazy" }
...
![](https://apqx.oss-cn-hangzhou.aliyuncs.com/blog/20190611/git_ssh.jpg){: loading="lazy" }

前提是，这个仓库必须是登录`GitHub`后通过`SSH URL`克隆下来的，使用`HTTPS URL`克隆的仓库，依然需要输入账号密码。

![](https://apqx.oss-cn-hangzhou.aliyuncs.com/blog/20190611/ssh_github.jpg){: loading="lazy" }