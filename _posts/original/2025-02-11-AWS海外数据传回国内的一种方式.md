...
要注意它在下载 YouTube 视频时可能触发对方的机器人验证，需导入登录过 YouTube 的浏览器 Cookies 避免，可使用 Chrome 的 [Get cookies.txt LOCALLY](https://chromewebstore.google.com/detail/get-cookiestxt-locally/cclelndahbckbenkjhflpdbgdldlbecc){: target="_blank" } 插件导出传输到 EC2 上。
