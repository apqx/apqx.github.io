...
域名可以由字母、数字甚至汉字组成，有意义的词自然比无规则数字清晰简洁，比如百度的拼音域名 baidu.com，在浏览器中输入就能跳转到百度网站。这个过程中浏览器做了 2 件事，先去 DNS 域名服务器查询域名对应的 IP 地址，再去访问 IP 对应的服务器，中间有很多复杂细节需要更多协议处理，但总之域名起到的就是这个作用。
