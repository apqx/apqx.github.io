...
redirect_from:
    - /essy/2020/06/12/使用Gradle创建不同的打包类型
---
...
![](https://apqx.oss-cn-hangzhou.aliyuncs.com/blog/20200612/gradle_task_build_variant.jpg){: loading="lazy" class="clickable clickShowOriginalImg" alt="pic" }
...
![](https://apqx.oss-cn-hangzhou.aliyuncs.com/blog/20200612/module_build_variant.png){: loading="lazy" class="clickable clickShowOriginalImg" alt="pic" }
