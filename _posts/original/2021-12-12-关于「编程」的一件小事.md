...
几个月前，我在新浪博客上找到了很多我喜欢的剧照，想下载保存，正常情况下点击网页里的缩略图就能跳转到原图然后即可下载，这些照片的质量很高，甚至保存着相机拍摄时的`Metadata`元信息。但有一些博文里的照片，跳转时却都会一直加载直到超时也没有显示出来，那时候我以为博客的图床已经停止服务，可能原图早就不存在了，就只下载了很模糊的缩略图。
