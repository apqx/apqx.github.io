...
author: 立泉
mention: Tag Liquid FrontMatter GithubPages
...
Jekyll 驱动的静态站点借助 [Liquid](https://shopify.github.io/liquid/){: target="_blank" } 模版语言实现标签并不复杂。
...
已有映射 JSON，点击`tag`加载对应文章列表显示出来可逐步轻松实现。额...好吧，非 Web 开发者如果不熟悉 JS 并不会很“轻松”，比如我，思路清晰但是对语法和类库陌生，以至于编码步履蹒跚。
