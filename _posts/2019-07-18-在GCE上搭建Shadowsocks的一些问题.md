...
![](https://apqx.oss-cn-hangzhou.aliyuncs.com/blog/20190718/gc_price.jpg){: loading="lazy" }
...
![](https://apqx.oss-cn-hangzhou.aliyuncs.com/blog/20190718/gc_firewall.jpg){: loading="lazy" }
...
![](https://apqx.oss-cn-hangzhou.aliyuncs.com/blog/20190718/gc_instance.jpg){: loading="lazy" }

# 安装&配置

在`VM instance`里找到上文创建的实例，点击`Connect`里的`SSH`

![](https://apqx.oss-cn-hangzhou.aliyuncs.com/blog/20190718/gc_connect.jpg){: loading="lazy" }

会在新的浏览器窗口里建立和服务器的`SSH`连接

![](https://apqx.oss-cn-hangzhou.aliyuncs.com/blog/20190718/gc_ssh.jpg){: loading="lazy" }
...
![](https://apqx.oss-cn-hangzhou.aliyuncs.com/blog/20190718/gc_ip.jpg){: loading="lazy" }
