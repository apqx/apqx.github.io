...
<resources>
    ...
    <style name="AppTheme.RED">
        ...
        <item name="commonBgColor">@color/commonBgRed</item>
    </style>
    <!-- 绿色主题 -->
    <style name="AppTheme.GREEN">
        <item name="commonTitleColor">@color/commonTitleGreen</item>
        <item name="commonBgColor">@color/commonBgGreen</item>
    </style>
</resources>
```
...
<img class="materialboxed responsive-img" src="https://apqx.oss-cn-hangzhou.aliyuncs.com/blog/pic/themeSelect.png" alt="pic">
